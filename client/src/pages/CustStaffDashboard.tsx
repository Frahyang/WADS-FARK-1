        ...
        <div className="w-full lg:w-1/2 bg-white lg:border-r border-gray-200">
          ...
          <div className="p-4 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              <div className="flex-1 relative pt-[15px]">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 lg:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm bg-white"
                />
              </div>
